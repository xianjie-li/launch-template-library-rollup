	...
	*/
	...
	var Icon = function Icon(props) {
	  var property = shakeFalsy({
	    className: classnames(props.className, iconMap[props.type], 'bk-icon', props.spin && 'bk-spin')
	  });
	  var sty = props.style || {};
	  var style = shakeFalsy(objectSpread({}, sty, {
	...
	var Skeleton = function Skeleton(_ref) {
	  var count = _ref.count,
	      ...
	      rand = _ref.rand,
	      props = objectWithoutProperties(_ref, ["count", "img", "loading", "lineCount", "rand"]);
